  ...
  return (
    <>
      <div className="w-screen h-screen flex flex-col items-center justify-center bg-black bg-gradient-to-tr from-sky-800/50 to-indigo-900/50 relative">
       <p className="text-xs text-sky-500 font-light font-helvetica pointer-none">{loadingFinished? 'SPACE SUIT PRESSURISED': 'PRESSURISING YOUR SPACE SUIT...'}</p>
        ...
        { loadingFinished &&
          <Link href={"/home"} className="absolute bottom-10 mt-32">
            <button
